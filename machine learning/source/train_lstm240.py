...
for experiment in range(num_experiments):
    ...
    # 保存模型
    model_path = os.path.join(model_dir, f"lstm_output_{output_length}_mse_{mse:.4f}_mae_{mae:.4f}_experiment_{experiment + 1}_{current_time}.pth")
